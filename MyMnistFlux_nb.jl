...
# ╔═╡ 5bda8a43-bd8c-4d82-ab16-f579c949aaea
begin
	using Flux, MLDatasets
	using Plots, Images, PlutoUI
end;

# ╔═╡ c43f275c-09ad-4b07-a6e2-10dcb266719d
md"""
# Loading MNIST Data
"""

# ╔═╡ 4607a082-cb00-4fef-b0da-82bea62afdc5
begin
...
# ╔═╡ 28beada9-1005-4088-9442-74d476f90d89
begin
	nb_train_images = size(x_train_raw)[3]
	md"""
	##### Training image $(@bind train_it Slider(1:nb_train_images, show_value=true)) / $nb_train_images
	"""
end

# ╔═╡ 437e0eac-ff1d-4e24-80a3-26fdcf2c5a05
plot(Gray.(x_train_raw[:, :, train_it]'),
	title="Label: $(y_train_cold[train_it])",
	axis = nothing)

# ╔═╡ e4ec683e-2bde-44a7-85c7-a6fde70ff710
md"""
# Setup for a (simple) model
This dense model contains 3 layers, with:
- The **input** layer containing **784** (28x28 pxl) neurons and using **ReLu** as the activation function.
- The **hidden** layer containing **256** neurons and using **ReLu** as the activation function.
- The **output** layer containing **10** neurons (1 per class a.k.a number) and using **Softmax** as the activation function.

The model use the classic **MSE** loss function and a gradient **Descent** as the optimizer.
"""

# ╔═╡ 7304f536-3e46-4392-b984-ef3fdb707d54
begin
	model = Flux.Chain(
	    Dense(784, 256, relu),
...
# ╔═╡ 8f6d3401-6242-40c7-8952-d2e37f2615ee
md"""
## Adapt Data for training model
"""
...
begin
	range = 1:nb_epochs
	plot(range, train_losses, label="Train loss", title="Evolution of Train & Test loss")
	plot!(range, test_losses, label="Test loss")
...
git-tree-sha1 = "f1e926b37a2e1f64388be59b1baff4152eae67b9"
